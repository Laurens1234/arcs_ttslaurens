...
local leaderCountDec_params = {
    ...
    function_owner = self,
    label = "-",
    tooltip = "Decrease leader draft count (0 = Auto)",
...
local leaderCountInc_params = {
    ...
    function_owner = self,
    label = "+",
    tooltip = "Increase leader draft count (0 = Auto)",
...
local loreCountDec_params = {
    ...
    function_owner = self,
    label = "-",
    tooltip = "Decrease lore draft count (0 = Auto)",
    position = {-1.82, 0.5, 0},
    width = 400,
    height = 220,
    font_size = 220,
...
local loreCountInc_params = {
    ...
    function_owner = self,
    label = "+",
    tooltip = "Increase lore draft count (0 = Auto)",
    position = {-1.2, 0.5, 0},
    width = 400,
    height = 220,
    font_size = 220,
